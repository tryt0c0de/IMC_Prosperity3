...
class Trader:
    ...
    def __init__(self, params=None):
        ...
        self.products = ['KELP', 'SQUID_INK', 'CROISSANTS', 'DJEMBES', 'JAMS', 'PICNIC_BASKET1', 'PICNIC_BASKET2', 'RAINFOREST_RESIN', 'VOLCANIC_ROCK']
        self.strikes = [9500, 9750, 10000, 10250, 10500]
        self.products.extend([f'VOLCANIC_ROCK_VOUCHER_{k}' for k in self.strikes])
    ...
    def run(self, state: TradingState):
        ...
        for prod in self.products:
            result[prod] = [Order(prod, 1000, 1000)]
