...
PARAMS = {
    Product.RAINFOREST_RESIN: {
        "fair_value": 10000,
        "take_width": 6, # Essentially we will never take except very weird stuff happens (it never deviates more than 5)
        "clear_width": 0,
        # for making
...
class Trader:
    def __init__(self, params=None):
        ...
        PARAMS[Product.KELP]["reversion_beta"] = -0.6
    ...
    def run(self, state: TradingState):
        ...
        if Product.RAINFOREST_RESIN in self.params and Product.RAINFOREST_RESIN in state.order_depths:
            ...
            result[Product.RAINFOREST_RESIN] = (
                 rainforest_clear_orders + rainforest_make_orders
            )
        conversions = 1
